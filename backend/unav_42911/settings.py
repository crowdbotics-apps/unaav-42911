"""
Django settings for unav_42911 project.
...
WSGI_APPLICATION = 'unav_42911.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "unav_42911 API",
    "DESCRIPTION": "API documentation for unav_42911 App",
    "VERSION": "v1",
}
